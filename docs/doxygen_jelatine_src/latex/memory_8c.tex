\section{src/jelatine/memory.c File Reference}
\label{memory_8c}\index{src/jelatine/memory.c@{src/jelatine/memory.c}}
...
\item 
\#define {\bf BIN\_\-MAX\_\-SIZE}~(BIN\_\-ENTRIES $\ast$ sizeof(jword\_\-t))
\item 
...
\item 
uintptr\_\-t {\bf gc\_\-new\_\-array\_\-nonref} (array\_\-type\_\-t type, int32\_\-t count)
\item 
uintptr\_\-t {\bf gc\_\-new\_\-array\_\-ref} ({\bf class\_\-t} $\ast$cl, int32\_\-t count)
\item 
uintptr\_\-t {\bf gc\_\-new\_\-multiarray} ({\bf class\_\-t} $\ast$cl, uint8\_\-t dimensions, jword\_\-t $\ast$counts)
\item 
...
\subsubsection[{BIN\_\-MAX\_\-SIZE}]{\setlength{\rightskip}{0pt plus 5cm}\#define BIN\_\-MAX\_\-SIZE~(BIN\_\-ENTRIES $\ast$ sizeof(jword\_\-t))}\label{memory_8c_a91c5e7cab9fb84f7358872d8fc0b01d5}
