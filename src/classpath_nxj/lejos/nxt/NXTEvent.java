...
public class NXTEvent {
	...
	//my mod
	private static final Object envents_global_lock=new Object();
	//envents_global_lock need for  use  synchronized(envents_global_lock) instead  synchronized(NXTEvent.class)
