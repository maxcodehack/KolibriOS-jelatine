...
public class Move implements Transmittable {
	...
	public class MoveType{
		public static final int TRAVEL=0, ROTATE=1, ARC=2, STOP=3; 
	};
	public static final int TRAVEL=0, ROTATE=1, ARC=2, STOP=3; //enum MoveType {TRAVEL, ROTATE, ARC, STOP}
  ...
  type, float distance, float angle, float travelSpeed, float rotateSpeed, boolean isMoving)
  {
    this.moveType = type;
    this.distanceTraveled = distance;
    this.angleTurned = angle;
   ...
   */
  public Move(int//MoveType 
  type, float distance, float angle, boolean isMoving)
  {
   ...
   * @param isMoving
   */
  public void setValues(int//MoveType
 type, float distance, float angle,boolean isMoving)
  {
    this.moveType = Move.calcMoveType(distance, angle);
	this.distanceTraveled = distance;
	...
	calcMoveType(float distance, float angle) {
	...
	public void dumpObject(DataOutputStream dos) throws IOException {
		dos.writeByte(moveType//moveType.ordinal()
		);
	...
	public void loadObject(DataInputStream dis) throws IOException {
		moveType = dis.readByte();//MoveType //MoveType.values()[dis.readByte()];
