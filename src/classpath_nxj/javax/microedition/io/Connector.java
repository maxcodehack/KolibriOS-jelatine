...
public class Connector
{
            ...
            IOException, SecurityException
    {
        ...
        String protocolClassName = protocolPath + "." + scheme + ".ProtocolImpl";
...
// 1. Parse out scheme, target, and possibly parameters from string.
    	...
    	final String target = url.getTarget();//parseTarget(name);
		...
		try {
            ...
            throw new ConnectionNotFoundException("Unknown Protocol: " + scheme);
        }
