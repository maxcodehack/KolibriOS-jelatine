...
public class StringBuilder implements CharSequence
{
  ...
  private StringBuilder appendInternal(String s) {
    ...
    char[] sc =s.value;// s.value;//s.characters;
    int sl = s.count;//sc.count;//sc.length;
    
    int newlen = curLen + sl;
    this.ensureCapacity(newlen);
    
    //System.arraycopy (sc, 0, characters, curLen, sl); 
	System.arraycopy (sc, s.offset, characters, curLen, sl);
    curLen = newlen;
  ...
  public int indexOf(String str, int fromIndex) {
	  ...
	  return String.indexOf(characters, 0, curLen,
                            str.value,//str.characters, 
							str.offset,//0, 
							str.count,//str.value.length,//str.characters.length, 
							fromIndex);
  }
  ...
  public int lastIndexOf(String str, int fromIndex) {
      return String.lastIndexOf(characters, 0, curLen,
							...
							//str.characters, 
							str.offset,//0, 
							str.count,//str.value.length,
							//str.characters.length, 
							fromIndex);
  }
